...
export default async function PublicProgramPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="partner-program-page">
      <header className="partner-program-nav"><Link className="brand" href="/"><span className="brand-mark">R</span><span>Relay</span></Link><span>Партнёрская программа · {company.name}</span></header>
