...
const plans = [
  { code: "TRIAL", name: "Старт", description: "Для проверки первого агентского канала.", features: ["Программы без ограничений в бете", "Кабинеты агентов", "5 000 AI-токенов при регистрации"] },
