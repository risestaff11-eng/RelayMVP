...
const plans = [
  ...
  { code: "STARTER", name: "Starter", price: "29 $ / мес", tokens: 500000, description: "Для запуска первого партнёрского канала.", features: ["Без лимита программ в бете", "До 100 партнёров", "500 000 AI-токенов"] },
