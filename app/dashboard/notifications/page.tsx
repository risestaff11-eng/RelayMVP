...
export default async function NotificationsPage() {
  ...
  const overduePayouts = rewardRows.filter(({ reward }) => reward.status === "APPROVED" && slaState(payoutDueAt(reward.approvedAt, reward.plannedAt, company.payoutSlaDays)).overdue);
