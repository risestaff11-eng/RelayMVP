...
export default async function SubmissionsPage() {
  ...
  return <div className="dashboard-content module-content operations-page">
    <div className="module-heading"><div><span className="module-kicker">РЕЗУЛЬТАТЫ ЗАДАНИЙ</span><h1>Очередь результатов</h1><p>Сначала показано то, что требует решения. Откройте карточку, проверьте данные и сообщите результат агенту.</p></div><Link className="button button-ghost compact-button" href="/dashboard/programs">Открыть программы →</Link></div>
