...
const missionTypes = [
  { type: "LEAD", title: "Лиды", icon: "↗", text: "Агент знакомит компанию с подходящим клиентом и передаёт согласованный контакт." },
...
export function NewProgramForm({ profileVersion, profileStatus }: { profileVersion: number | null; profileStatus: string }) {
  const router = useRouter();
  const [name, setName] = useState("Лиды и сделки");
