...
function whatsapp(phone: string, name: string) {
  ...
  const text = encodeURIComponent(`Здравствуйте, ${name}! Пишу вам как представитель компании, к агентской кампании которой вы присоединились через Relay.`);
