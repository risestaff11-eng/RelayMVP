...
export default async function RewardsPage() {
  ...
  const rows = rewardRows.map(({ reward, agent, submission, mission, program }) => ({ id: reward.id, agentName: agent.name, agentEmail: agent.email, missionTitle: mission.title, programName: program.name, contactName: submission.contactName, contactCompany: submission.contactCompany, amount: reward.amount, currency: reward.currency, status: reward.status, plannedAt: reward.plannedAt, paidAt: reward.paidAt, partnerConfirmedAt: reward.partnerConfirmedAt, createdAt: reward.createdAt }));
