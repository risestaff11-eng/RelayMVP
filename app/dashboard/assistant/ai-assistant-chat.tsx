  ...
  async function apply(action: Action) {
    ...
    try {
      if (action.type === "OPEN_SECTION") {
        const allowed: Record<string, string> = { results: "/dashboard/submissions", agents: "/dashboard/partners", rewards: "/dashboard/rewards", analytics: "/dashboard/analytics", programs: "/dashboard/programs", profile: "/dashboard/company-profile", settings: "/dashboard/settings" };
