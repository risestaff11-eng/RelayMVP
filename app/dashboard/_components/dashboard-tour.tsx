...
const steps = [
  ...
  { target: "crm", title: "CRM", text: "Ведите клиента от новой заявки до сделки и сразу видьте, кто его привёл." },
  { target: "rewards", title: "Выплаты", text: "Контролируйте начисления, сроки и отметки о фактической выплате." },
  { target: "agent-rating", title: "Рейтинг агентов", text: "Сравнивайте сделки, конверсию, деньги и активность участников." },
