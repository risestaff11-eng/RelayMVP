...
import { newTrial } from "../../../../lib/subscription-plans";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    await db.batch([
      ...
      db.insert(companies).values({ id: companyId, ownerUserId: user.userId, name, website, industry, teamSize, primaryGoal, aiTokenBalance: INITIAL_COMPANY_AI_CREDITS, ...newTrial() }),
