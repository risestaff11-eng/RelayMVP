...
export const metadata = publicMetadata("Интеграторам RiseStaff", "Настраивайте RiseStaff для компаний и зарабатывайте на запуске, материалах и сопровождении агентских программ.", "/integrators");
