  ...
  return <main className="integrator-page">
    ...
    <section className="integrator-hero" id="main-content">
      <div className="integrator-center">
        ...
        <h1>Запускайте Relay клиентам и зарабатывайте на настройке.</h1>
      ...
      <div className="integrator-logo-grid" aria-label="Преимущества интегратора Relay">
        ...
        <article className="tile-dark"><small>02 · ГОТОВЫЙ СЕРВИС</small><h2>Работайте в кабинетах Relay</h2><p>Компания проверяет результаты, агент выполняет задания, а история хранится в одном сервисе.</p><b aria-hidden="true">◎</b></article>
