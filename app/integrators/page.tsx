...
export const metadata: Metadata = { title: "Интеграторам агентских программ", description: "Запускайте агентские каналы для клиентов вместе с Relay и зарабатывайте на внедрении и сопровождении.", alternates: { canonical: "https://risestaff.kz/integrators" } };
