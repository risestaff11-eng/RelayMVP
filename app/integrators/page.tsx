...
export const metadata: Metadata = { title: "Интеграторам Yaler", description: "Настраивайте Yaler для компаний и зарабатывайте на запуске, материалах и сопровождении агентских программ.", alternates: { canonical: "https://risestaff.kz/integrators" } };
  ...
  return <main className="integrator-page">
    ...
    <section className="integrator-hero" id="main-content">
      <div className="integrator-center">
        ...
        <h1>Запускайте Yaler клиентам и зарабатывайте на настройке.</h1>
      ...
      <div className="integrator-logo-grid" aria-label="Преимущества интегратора Yaler">
        ...
        <article className="tile-dark"><small>02 · ГОТОВЫЙ СЕРВИС</small><h2>Работайте в кабинетах Yaler</h2><p>Компания проверяет результаты, агент выполняет задания, а история хранится в одном сервисе.</p><b aria-hidden="true">◎</b></article>
