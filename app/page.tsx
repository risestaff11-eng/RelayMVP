...
export default async function Home() {
  ...
  return <main className="lp-shell">
    ...
    <section className="lp-ai lp-section" id="product"><i className="lp-motion-orbit orbit-gray" aria-hidden="true" />
      <figure className="lp-ai-visual lp-live-screen"><div className="lp-live-screen-label"><span>КАБИНЕТ КОМПАНИИ</span><b>Рабочий стол Relay</b></div><img src="/company-cabinet.png?v=20260818" width="1440" height="900" loading="lazy" alt="Реальный рабочий стол компании в Relay с программами, агентами, результатами и выплатами" /></figure>
    ...
    <section className="lp-partner lp-section" id="partners"><i className="lp-motion-orbit orbit-lime" aria-hidden="true" />
      ...
      <figure className="lp-partner-card lp-live-screen lp-agent-live-screen"><div className="lp-live-screen-label"><span>КАБИНЕТ АГЕНТА</span><b>Доступные задания</b></div><img src="/agent-cabinet.png?v=20260818" width="1440" height="900" loading="lazy" alt="Реальный кабинет агента Relay с доступными заданиями и условиями вознаграждения" /></figure>
    </section>

    <section className="lp-audience lp-section"><div className="lp-section-intro"><span>КОМУ ПОДХОДИТ</span><h2>Тем, у кого покупают через доверие и рекомендации.</h2></div><div className="lp-audience-grid">
      <article><b>01</b><div className="lp-role-visual lp-role-sales" aria-hidden="true"><div><span>АГЕНТЫ</span><strong>14</strong><i>+3 за неделю</i></div><div><span>РЕЗУЛЬТАТЫ</span><strong>6</strong><i>3 на проверке</i></div><footer><em /><em /><em /><em /></footer></div><h3>Руководителю продаж</h3><p>Подключить внешних продавцов и видеть вклад каждого без новой CRM.</p></article>
      <article><b>02</b><div className="lp-role-visual lp-role-marketing" aria-hidden="true"><header><span>КАМПАНИЯ</span><i>● активна</i></header><strong>Амбассадоры бренда</strong><div><span>8 заданий</span><span>24 отклика</span></div><footer><i /><i /><i /><i /><i /></footer></div><h3>Руководителю маркетинга</h3><p>Запустить амбассадорские и имиджевые задания с понятной проверкой.</p></article>
      <article><b>03</b><div className="lp-role-visual lp-role-founder" aria-hidden="true"><header><span>АГЕНТСКИЙ КАНАЛ</span><strong>+32%</strong></header><div className="lp-role-bars"><i /><i /><i /><i /><i /><i /></div><footer><span>ПРОГРАММЫ&nbsp; 3</span><span>АГЕНТЫ&nbsp; 14</span></footer></div><h3>Основателю компании</h3><p>Превратить сеть знакомых, клиентов и экспертов в повторяемый канал.</p></article>
    </div></section>
