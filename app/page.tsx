...
export default async function Home() {
  ...
  return <main className="lp-shell">
    ...
    <header className="lp-header">
      ...
      <div className="lp-header-actions"><a className="lp-login" href={loginHref}>{user ? "Кабинет" : "Начать бесплатно"}</a><a className="lp-nav-cta lp-whatsapp-cta" href={whatsappHref} target="_blank" rel="noreferrer"><span className="lp-whatsapp-icon" aria-hidden="true" />Обсудить Relay</a></div>
    </header>
    ...
    <section className="lp-hero" id="main-content">
      ...
      <div className="lp-hero-copy">
        ...
        <h1>Получайте <span className="lp-color-word">новых клиентов</span> от внешних агентов — без потерь в чатах и таблицах.</h1>
        ...
        <div className="lp-mobile-audience" aria-label="Для кого и какую задачу решает Relay"><span><b>ДЛЯ КОГО</b>Владельцы и руководители продаж</span><span><b>ВМЕСТО ЧЕГО</b>Чаты, таблицы и ручная сверка рекомендаций</span></div>
    ...
    <section className="lp-product lp-section" id="product"><i className="lp-motion-orbit orbit-blue" aria-hidden="true" />
      ...
      <div className="lp-real-screens"><figure><div className="lp-real-screen-label"><span>КАБИНЕТ КОМПАНИИ</span><b>Управление каналом</b></div><img src="/company-cabinet.png" width="1440" height="900" loading="lazy" alt="Рабочий стол компании в Relay с программами, агентами, результатами и выплатами" /><figcaption><strong>Вся агентская сеть в одном окне</strong><span>Программы, участники, результаты и выплаты доступны владельцу бизнеса.</span></figcaption></figure><figure><div className="lp-real-screen-label"><span>КАБИНЕТ АГЕНТА</span><b>Задания и заработок</b></div><img src="/agent-cabinet.png" width="1440" height="900" loading="lazy" alt="Кабинет агента Relay с заданиями, статусами рекомендаций и вознаграждениями" /><figcaption><strong>Понятный путь до вознаграждения</strong><span>Агент видит возможности, прогресс каждой рекомендации и доступные выплаты.</span></figcaption></figure></div>
    </section>

    <section className="lp-ai lp-section"><i className="lp-motion-orbit orbit-gray" aria-hidden="true" />
      <div className="lp-ai-visual lp-app-shot" aria-label="Экран AI-профиля компании в Relay"><div className="lp-app-shot-top"><div><MarketingLogo /><strong>Relay</strong></div><span>AI-ПРОФИЛЬ КОМПАНИИ</span><b>Черновик готов</b></div><div className="lp-app-shot-body"><aside><small>РАЗДЕЛЫ</small><span>Обзор</span><span className="active">✦ AI-профиль</span><span>Программы</span><span>Агенты</span></aside><section><div className="lp-app-shot-url"><small>САЙТ КОМПАНИИ</small><strong>relay-demo.kz</strong><span>✓ анализ завершён</span></div><div className="lp-app-shot-fields"><article><small>ОПИСАНИЕ БИЗНЕСА</small><p>Сервисы автоматизации продаж и партнёрского канала.</p></article><article><small>ПРОДУКТЫ И УСЛУГИ</small><p>Аудит, настройка, интеграции и обучение команды.</p></article><article><small>ЦЕЛЕВАЯ АУДИТОРИЯ</small><p>Владельцы и руководители растущих компаний.</p></article><article><small>ПРЕИМУЩЕСТВА</small><p>Запуск за 30 дней и прозрачный план внедрения.</p></article></div><div className="lp-app-shot-confirm"><span>Проверьте данные перед созданием программы</span><b>Подтвердить профиль →</b></div></section></div></div>
    ...
    <section className="lp-partner lp-section" id="partners"><i className="lp-motion-orbit orbit-lime" aria-hidden="true" />
      <div className="lp-partner-copy"><span>ПОЧЕМУ АГЕНТ ВЕРНЁТСЯ</span><h2>Агент возвращается.<br /><TypedReasons /></h2><p>Агент сразу видит доступные задания, условия вознаграждения и движение каждой рекомендации до фактического получения денег.</p><div className="lp-earning-summary"><div><b>4</b><span>ЗАДАНИЯ ДОСТУПНЫ</span></div><div><b>30 000 ₸</b><span>ЛУЧШАЯ НАГРАДА</span></div></div></div>
      <div className="lp-partner-card"><div><small>СВОДКА ПО ЗАРАБОТКУ</small><strong>Обновлено сегодня</strong></div><ul><li className="done">✓ 45 000 ₸ получено</li><li className="done">✓ 30 000 ₸ к выплате</li><li>2 рекомендации проверяются</li></ul><footer><span>Следующее действие</span><b>Выбрать задание с наградой до 50 000 ₸</b></footer></div>
    </section>

    <section className="lp-audience lp-section"><div className="lp-section-intro"><span>КОМУ ПОДХОДИТ</span><h2>Тем, у кого покупают через доверие и рекомендации.</h2></div><div className="lp-audience-grid"><article><b>01</b><h3>Руководителю продаж</h3><p>Подключить внешних продавцов и видеть вклад каждого без новой CRM.</p></article><article><b>02</b><h3>Руководителю маркетинга</h3><p>Запустить амбассадорские и имиджевые задания с понятной проверкой.</p></article><article><b>03</b><h3>Основателю компании</h3><p>Превратить сеть знакомых, клиентов и экспертов в повторяемый канал.</p></article></div></section>
