...
const faqs = [
  ...
  ["Как Relay фиксирует лид?", "Сервис сохраняет агента, дату передачи, контакт, комментарии и историю статусов. Перед проверкой компания видит, кто и когда передал результат."],
  ...
  ["Что делает AI внутри Relay?", "AI готовит черновики заданий и материалов из данных компании. Пользователь редактирует текст и подтверждает его перед публикацией."],
  ["Заменяет ли Relay CRM?", "CRM хранит клиентов и ведёт сделки. Relay отвечает за работу с внешними агентами: задания, авторство результата, проверку и вознаграждения."],
