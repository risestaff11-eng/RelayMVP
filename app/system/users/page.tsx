...
import { productFunnel } from "@/db/product-funnel";
...
export default async function SystemUsersPage() {
  ...
  return <><SystemUsers authorized={authorized} initialRows={rows} initialDeletedRows={deletedRows} initialApplications={applications} initialCompanyApplications={companyApplications} generatedAt={new Date().toISOString()} />{authorized && <ProductFunnel data={await productFunnel()} />}</>;
}
