  ...
  return (
    <main className="partner-portal-shell">
      <aside className="partner-portal-sidebar">
        ...
        <div className="partner-company-chip"><CompanyLogo company={portal.company} /><small>КОМПАНИЯ</small><strong>{portal.company.name}</strong><span>● {portal.programs.length} программ · задания доступны</span><a href="/agent">Сменить компанию ↗</a></div>
