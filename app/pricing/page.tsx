...
const plans = [
  ...
  { code: "02", name: "Рост", label: "МАСШТАБИРОВАТЬ", text: "Для команды с несколькими продуктами и регулярным потоком лидов от агентов, клиентов и отраслевых экспертов.", features: ["Несколько направлений и программ", "Расширенная работа с агентами", "Приоритетные задания и уровни", "Аналитика агентского канала"] },
